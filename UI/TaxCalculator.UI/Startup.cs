...
using TaxCalculator.Repository.Repository;
...
namespace TaxCalculator.UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IIncomeTaxRepository, IncomeTaxRepository>();
            services.AddTransient<ITaxQueryLogRepository, TaxQueryLogRepository>();


            services.AddDbContext<TaxCalculatorDbContext>(options =>
                options.UseSqlServer(
                    Configuration.GetConnectionString("TaxDbConnection"), b => b.MigrationsAssembly("TaxCalculator.UI")));
